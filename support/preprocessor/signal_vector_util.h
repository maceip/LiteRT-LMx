...
#ifndef THIRD_PARTY_ODML_LITERT_LM_SUPPORT_PREPROCESSOR_SIGNAL_VECTOR_UTIL_H_
#define THIRD_PARTY_ODML_LITERT_LM_SUPPORT_PREPROCESSOR_SIGNAL_VECTOR_UTIL_H_
...
#endif  // THIRD_PARTY_ODML_LITERT_LM_SUPPORT_PREPROCESSOR_SIGNAL_VECTOR_UTIL_H_
