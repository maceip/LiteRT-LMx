...
SerialExecutionManager::ExportSessionSnapshot(
...
absl::Status SerialExecutionManager::ExportSessionSnapshotTo(
    SessionId session_id, const absl::flat_hash_set<TaskId>& boundary_tasks,
...
absl::Status SerialExecutionManager::ImportSessionSnapshotFrom(
    SessionId session_id, const ExecutorSessionSnapshot& snapshot,
